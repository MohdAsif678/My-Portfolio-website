        ...
        <div className="services_container container grid">
            <div className="services_content">
                ...
                <div className={Toggle === 1? "services_modal active_modal":"services_modal"}>
                    <div className="services_modal-content">
                        ...
                        <p className="services_modal-description">Building responsive and high-performance websites.</p>
                        
                        <ul className="services_modal-services grid">
                            <li className="services_modal-services">
                                <i className="uil uil-check-circle services_modal-icon"></i>
                                <p className="services_modal-info">I develop the creative user interfaces.</p>
                            </li>
            ...
            <div className="services_content">
                <div>
                    ...
                    <h3 className="services_title">UI/UX <br />Desinger</h3>
                </div>
                ...
                <div className={Toggle === 2? "services_modal active_modal":"services_modal"}>
                    <div className="services_modal-content">
                        ...
                        <p className="services_modal-description">Created user interfaces and optimizes user experiences for digital products.</p>
                        <ul className="services_modal-services grid">
                            <li className="services_modal-services">
                                <i className="uil uil-check-circle services_modal-icon"></i>
                            ...
                            <li className="services_modal-services">
                                <i className="uil uil-check-circle services_modal-icon"></i>
                                <p className="services_modal-info">Wireframing & Prototyping.</p>
                            </li>
             ...
             <div className="services_content">
                <div>
                    ...
                    <h3 className="services_title">Photography <br /> Videography</h3>
                </div>
                ...
                <div className={Toggle === 3? "services_modal active_modal":"services_modal"}>
                    <div className="services_modal-content">
                        ...
                        <h3 className="services_modal-title">Photography & Videography</h3>
                        <p className="services_modal-description">Capturing the best moments with creativity and precision.</p>
